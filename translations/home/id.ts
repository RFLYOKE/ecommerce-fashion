const translations = {
  ...
  "hero-title-3": "dengan YAMEIYA SKINCARE",
  "hero-subtitle":
  ...
  "cta-subtitle":
    "Rasakan kelembapan, kecerahan, dan kesehatan kulit bersama YAMEIYA SKINCARE. Temukan produk yang cocok untuk kebutuhan kulitmu.",
