...
const testimonials = [
  {
    ...
    role: "Pelanggan",
    feedback:
      "Setelah 2 minggu pakai YAMEIYA SKINCARE, kulitku jadi lebih lembap dan cerah. Produk ini bener-bener bikin percaya diri!",
  ...
  },
  {
    ...
    role: "Pelanggan",
    feedback:
      "Aku punya kulit sensitif, tapi skincare YAMEIYA SKINCARE ternyata aman banget dan bikin kulitku glowing tanpa iritasi.",
